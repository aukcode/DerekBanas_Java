...
public class _08_MonsterTwo {
    ...
    public _08_MonsterTwo(int health, int attack, int movement, String name){
        this.health = health;
        this.attack = attack;
    ...
    public void moveMonster(_08_MonsterTwo[] monster, int arrayItemIndex){
    ...
    public boolean onMySpace(_08_MonsterTwo[] monster, int indexToChk1, int indexToChk2){
        ...
        if((monster[indexToChk1].xPosition) == (monster[indexToChk2].xPosition) &&
            ...
            return false; //Slot is free / contains a '*'
        }
    } // END OF onMySpace
